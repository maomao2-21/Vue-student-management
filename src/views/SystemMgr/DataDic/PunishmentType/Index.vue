...
export default Vue.extend({
  ...
  data() {
    return {
      setting: {
        title: "处分类型",
        action: "/api/dic-punishment-type",
        searchFormItem: [
        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "SystemMgr_DataDic_PunishmentType_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "查看",
            drawer: "detail",
            power: "SystemMgr_DataDic_PunishmentType_Get",
          },
          {
            type: "drawer",
            theme: "warning",
            ...
            label: "编辑",
            drawer: "form",
            power: "SystemMgr_DataDic_PunishmentType_Put",
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/dic-punishment-type",
            power: "SystemMgr_DataDic_PunishmentType_Delete",
          },
        ],
        columns: [
