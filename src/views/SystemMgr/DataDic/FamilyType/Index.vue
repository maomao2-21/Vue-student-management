        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "SystemMgr_DataDic_FamilyType_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "查看",
            drawer: "detail",
            power: "SystemMgr_DataDic_FamilyType_Get",
          },
          {
            type: "drawer",
            theme: "warning",
            ...
            label: "编辑",
            drawer: "form",
            power: "SystemMgr_DataDic_FamilyType_Put",
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/dic-family-type",
            power: "SystemMgr_DataDic_FamilyType_Delete",
          },
        ],
        columns: [
