...
export default Vue.extend({
  ...
  data() {
    return {
      setting: {
        title: "扣分类型",
        action: "/api/dic-deduct-point-type",
        searchFormItem: [
        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "SystemMgr_DataDic_DeductPointType_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "查看",
            drawer: "detail",
            power: "SystemMgr_DataDic_DeductPointType_Get",
          },
          {
            type: "drawer",
            theme: "warning",
            ...
            label: "编辑",
            drawer: "form",
            power: "SystemMgr_DataDic_DeductPointType_Put",
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/dic-deduct-point-type",
            power: "SystemMgr_DataDic_DeductPointType_Delete",
          },
        ],
        columns: [
