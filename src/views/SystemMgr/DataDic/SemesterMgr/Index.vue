        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "SystemMgr_DataDic_SemesterMgr_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "查看",
            drawer: "detail",
            power: "SystemMgr_DataDic_SemesterMgr_Get",
          },
          {
            type: "drawer",
            theme: "warning",
            ...
            label: "编辑",
            drawer: "form",
            power: "SystemMgr_DataDic_SemesterMgr_Put",
          },
          {
            type: "api",
            theme: "primary",
            ...
            label: "当前学期",
            method: "post",
            action: "/api/semester/set-current/{Id}",
            power: "SystemMgr_DataDic_SemesterMgr_SetCurrent",
            width: 110,
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/semester",
            power: "SystemMgr_DataDic_SemesterMgr_Delete",
          },
        ],
        columns: [
