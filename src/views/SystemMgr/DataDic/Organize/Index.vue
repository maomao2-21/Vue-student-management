        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "SystemMgr_DataDic_Organize_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "查看",
            drawer: "detail",
            power: "SystemMgr_DataDic_Organize_Get",
          },
          {
            type: "drawer",
            theme: "warning",
            ...
            label: "编辑",
            drawer: "form",
            power: "SystemMgr_DataDic_Organize_Put",
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/dic-organize",
            power: "SystemMgr_DataDic_Organize_Delete",
          },
        ],
        columns: [
