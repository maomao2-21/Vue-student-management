        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "SystemMgr_DataDic_Nation_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "查看",
            drawer: "detail",
            power: "SystemMgr_DataDic_Nation_Get",
          },
          {
            type: "drawer",
            theme: "warning",
            ...
            label: "编辑",
            drawer: "form",
            power: "SystemMgr_DataDic_Nation_Put",
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/dic-nation",
            power: "SystemMgr_DataDic_Nation_Delete",
          },
        ],
        columns: [
