  ...
  data() {
    return {
      setting: {
        ...
        span: 24,
        title: "学期总结",
        action: "/api/class-semester-summary",
        searchFormItem: [
          {
            type: "select",
            prop: "SemesterId",
          ...
          },
          {
            ...
            prop: "Type",
            label: "类型",
            action: "/api/class-semester-summary/type-dropdown-box",
            options: [],
            loading: false,
            span: 8,
          },
        ...
        titleBtns: [
          {
            ...
            label: "添加",
            drawer: "form",
            power: "ClassThing_SemesterSummary_Post",
          },
        ],
        rowBtns: [
          {
            ...
            label: "编辑",
            drawer: "form",
            power: "ClassThing_SemesterSummary_Put",
          },
          {
            type: "drawer",
            theme: "default",
            ...
            label: "查看",
            drawer: "detail",
            power: "ClassThing_SemesterSummary_Get",
          },
        ],
        batchBtns: [
          {
            ...
            method: "delete",
            action: "/api/class-semester-summary",
            power: "ClassThing_SemesterSummary_Delete",
          },
        ],
        columns: [
          { prop: "Type", label: "类型", title: true },
